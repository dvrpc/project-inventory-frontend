...
const ProjectCard = (props: Props) => {
  ...
  return (
    <div
      ...
      className="flex shadow-[0px_2px_4px_0px_#0000004d] border-t border-dvrpc-gray-7 rounded p-2 hover:shadow-[0px_4px_8px_0px_#0000004d] transition-colors hover:cursor-pointer pr-4"
    >
